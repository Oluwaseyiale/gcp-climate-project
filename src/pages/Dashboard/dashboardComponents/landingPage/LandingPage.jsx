...
import { useUserProfile, useAllCourses, useEnroll } from "../../../../api/queries";
	...
	return (
		<div>
			...
			{/* available courses section*/}
				  ...
				  <h1 className='my-5 text-xl text-center font-figtree'>See list of available courses to enroll for</h1>
			

			<div className="flex flex-wrap gap-6 px-10">
        {
          availableCourses.map((course) => (
            <div key={course.id} className="py-4 flex-1 px-5 bg-[#FFFFFF] h-[360px] w-[290px] border rounded-[10px] flex flex-col shadow-custom  mb-8">
              <img
